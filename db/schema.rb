...
ActiveRecord::Schema.define(version: 20180622063921) do
  ...
  add_index "products_statuses", ["product_id", "status_id"], name: "index_products_statuses_on_product_id_and_status_id", using: :btree
  ...
  add_index "user_tenants", ["tenant_id"], name: "index_user_tenants_on_tenant_id", using: :btree
  add_index "user_tenants", ["user_id"], name: "index_user_tenants_on_user_id", using: :btree
